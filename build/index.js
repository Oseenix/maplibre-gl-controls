...
const xn = ({
  ...
  p.appendChild(re(Cn)), p.onclick = c, p.style.border = "0", p.style.height = "24px", p.style.borderRadius = "4px";
  const d = () => {
  ...
  const k = () => I.style.backgroundColor === de, x = () => {
    k() || (I.style.backgroundColor = de, ye = setInterval(() => {
      f();
    }, e));
  }, I = document.createElement("button");
  I.appendChild(re(wn)), I.style.border = "0", I.style.height = "24px", I.style.borderRadius = "4px", I.onclick = x;
  const T = document.createElement("button");
  return T.appendChild(re(Mn)), T.style.border = "0", T.style.height = "24px", T.style.borderRadius = "4px", T.onclick = f, o.appendChild(p), o.appendChild(y), o.appendChild(I), o.appendChild(T), r.appendChild(o), {
    container: r,
    titleDiv: i,
    slider: s,
    increment: f,
...
const Ie = { kind: "null" }, h = { kind: "number" }, b = { kind: "string" }, g = { kind: "boolean" }, j = { kind: "color" }, Te = { kind: "projectionDefinition" }, Y = { kind: "object" }, m = { kind: "value" }, En = { kind: "error" }, $e = { kind: "collator" }, Ae = { kind: "formatted" }, De = { kind: "padding" }, ce = { kind: "resolvedImage" }, Se = { kind: "variableAnchorOffsetCollection" };
function A(n, e) {
  return {
    kind: "array",
    itemType: n,
...
const Wt = 0.96422, _t = 1, Ut = 0.82521, Xt = 4 / 29, K = 6 / 29, Zt = 3 * K * K, Tn = K * K * K, $n = Math.PI / 180, An = 180 / Math.PI;
function Jt(n) {
...
function Gt([n, e, t, r]) {
  ...
  let i, s;
  const o = He((0.2225045 * n + 0.7168786 * e + 0.0606169 * t) / _t);
  n === e && e === t ? i = s = o : (i = He((0.4360747 * n + 0.3850649 * e + 0.1430804 * t) / Wt), s = He((0.0139322 * n + 0.0971045 * e + 0.7141733 * t) / Ut));
  const a = 116 * o - 16;
...
function Nn(n) {
  ...
  if (n.startsWith("rgb")) {
    ...
    if (s) {
      ...
      if (T === "  " || T === "  /" || T === ",," || T === ",,,") {
        const O = [l, f, y].join(""), pe = O === "%%%" ? 100 : O === "" ? 255 : 0;
        if (pe) {
          const xt = [
            G(+a / pe, 0, 1),
            G(+c / pe, 0, 1),
...
function ae(n) {
  if (n === null || typeof n == "string" || typeof n == "boolean" || typeof n == "number" || n instanceof D || n instanceof w || n instanceof st || n instanceof z || n instanceof $ || n instanceof S || n instanceof H)
    return !0;
  if (Array.isArray(n)) {
    for (const e of n)
      if (!ae(e))
...
function ie(n) {
  const e = typeof n;
  return n === null ? "" : e === "string" || e === "number" || e === "boolean" ? String(n) : n instanceof w || n instanceof D || n instanceof z || n instanceof $ || n instanceof S || n instanceof H ? n.toString() : JSON.stringify(n);
}
class ee {
  constructor(e, t) {
    ...
    for (let t = 0; t < this.args.length; t++) {
      ...
      if (se(this.type, E(r))) {
        if (t === this.args.length - 1)
          throw new M(`Expected value to be of type ${C(this.type)}, but found ${C(E(r))} instead.`);
      } else return r;
    }
    throw new Error();
  }
...
const $t = ["Unknown", "Point", "LineString", "Polygon"], On = {
  Unknown: "Unknown",
  Point: "Point",
  MultiPoint: "Point",
...
class en {
  ...
  geometryDollarType() {
    return this.feature ? typeof this.feature.type == "number" ? $t[this.feature.type] : On[this.feature.type] : null;
  }
  geometryType() {
...
class at {
  ...
  static parse(e, t) {
    ...
    return !r || !i ? null : it(r.type, [g, b, h, Ie, m]) ? new at(r, i) : t.error(`Expected first argument to be of type boolean, string, number or null, but found ${C(r.type)} instead`);
  }
  evaluate(e) {
    ...
    if (!U(t, ["boolean", "string", "number", "null"]))
      throw new M(`Expected first argument to be of type boolean, string, number or null, but found ${C(E(t))} instead.`);
    if (!U(r, ["string", "array"]))
      throw new M(`Expected second argument to be of type array or string, but found ${C(E(r))} instead.`);
...
class ke {
  ...
  evaluate(e) {
    ...
    if (U(t, ["array"]))
      return t.slice(r, i);
    throw new M(`Expected first argument to be of type array or string, but found ${C(E(t))} instead.`);
  }
  eachChild(e) {
...
class P {
  ...
  static parse(e, t) {
    ...
    return !J(l, h) && !J(l, Te) && !J(l, j) && !J(l, De) && !J(l, Se) && !J(l, A(h)) ? t.error(`Type ${C(l)} is not interpolatable.`) : new P(l, r, i, s, a);
  }
  evaluate(e) {
    const t = this.labels, r = this.outputs;
    if (t.length === 1)
    ...
    for (let o = 1; o <= e.length - 1; ++o) {
      ...
      if (s && typeof a == "object" && !Array.isArray(a)) {
        ...
        if (a["font-scale"] && (l = t.parse(a["font-scale"], 1, h), !l))
          return null;
        let u = null;
        if (a["text-font"] && (u = t.parse(a["text-font"], 1, A(b)), !u))
          return null;
        let c = null;
...
class pt {
  ...
  evaluate(e) {
    ...
    if (Array.isArray(t))
      return t.length;
    throw new M(`Expected value to be of type string or array, but found ${C(E(t))} instead.`);
  }
  eachChild(e) {
    e(this.input);
  }
...
function Be(n, e, t, r) {
  ...
  return br(s, i) === 0 ? !1 : !!(St(n, e, t, r) && St(t, r, n, e));
}
function yr(n, e, t) {
  for (const r of t)
...
function Tr(n, e, t, r = 1 / 0) {
  ...
  for (const a of n)
    for (let l = 0, u = a.length, c = u - 1; l < u; c = l++) {
      const f = a[c], p = a[l];
      for (const d of e)
        for (let y = 0, k = d.length, x = k - 1; y < k; x = y++) {
          const I = d[x], T = d[y];
          if (Be(f, p, I, T))
            return 0;
...
function $r(n, e) {
  ...
  for (const o of e) {
    switch (o.type) {
      case "Point":
        s = Math.min(s, xe(r, !1, [o.coordinates], !1, i, s));
        break;
      case "LineString":
        s = Math.min(s, xe(r, !1, o.coordinates, !0, i, s));
        break;
      case "Polygon":
...
function Ar(n, e) {
  ...
  for (const o of e) {
    switch (o.type) {
      case "Point":
        s = Math.min(s, xe(r, !0, [o.coordinates], !1, i, s));
        break;
      case "LineString":
        s = Math.min(s, xe(r, !0, o.coordinates, !0, i, s));
        break;
      case "Polygon":
  ...
  static parse(e, t) {
    ...
    for (const [u, c] of a) {
      ...
      for (let d = 1; d < e.length; d++) {
        const y = e[d], k = Array.isArray(u) ? u[d - 1] : u.type, x = l.parse(y, 1 + f.length, k);
        if (!x) {
          p = !0;
          break;
        }
  ...
  if (r) {
    ...
    for (let y = 0; y < n.stops.length; y++) {
      ...
      c[x] === void 0 && (c[x] = {
        ...
        default: n.default,
        stops: []
      }, f.push(x)), c[x].stops.push([k[0].value, k[1]]);
    }
    const p = [];
    for (const y of f)
...
function qt(n, e, t) {
  ...
  const s = Fe(n.stops.map((c) => c[0]), t), o = Or(t, r, n.stops[s][0], n.stops[s + 1][0]), a = n.stops[s][1], l = n.stops[s + 1][1], u = Wn[e.type] || Fr;
...
function Hr(n, e) {
  ...
  if (pn(n)) {
    ...
    let t = n;
    return e.type === "color" && typeof n == "string" ? t = w.parse(n) : e.type === "padding" && (typeof n == "number" || Array.isArray(n)) ? t = $.parse(n) : e.type === "variableAnchorOffsetCollection" && Array.isArray(n) ? t = S.parse(n) : e.type === "projectionDefinition" && typeof n == "string" && (t = D.parse(n)), {
      kind: "constant",
      evaluate: () => t
    };
  }
...
function Vr(n) {
  return n.type === "color" && cn(n.default) ? new w(0, 0, 0, 0) : n.type === "color" ? w.parse(n.default) || null : n.type === "padding" ? $.parse(n.default) || null : n.type === "variableAnchorOffsetCollection" ? S.parse(n.default) || null : n.type === "projectionDefinition" ? D.parse(n.default) || null : n.default === void 0 ? null : n.default;
}
function gn(n) {
  if (n === !0 || n === !1)
    return !0;
...
class Gr {
  ...
  updateInnerContainerStyle(e) {
    ...
    r >= 480 && (s = 15, o = 15, u = Math.max(15, a), c = Math.max(15, l)), r >= 992 && i >= 992 && (u = Math.max(40, a), c = Math.max(40, l)), (f = this.options.position) != null && f.endsWith("left") ? (e.style.marginLeft = `${u}px`, e.style.marginRight = `${l}px`) : (e.style.marginLeft = `${a}px`, e.style.marginRight = `${c}px`), e.style.marginTop = `${s}px`, e.style.marginBottom = `${o}px`;
  }
  update() {
...
const _r = (n) => {
  const e = document.createElement("img");
  return e.src = `data:image/svg+xml,${encodeURIComponent(n)}`, e.style.width = "20px", e.style.height = "20px", e;
}, Ur = "rgb(204, 204, 204)";
class Qr {
  constructor(e) {
    v(this, "map");
    ...
    this.options = e, this.container = this.createContainer();
  }
  // Create the outer container for the control
  createContainer() {
    const e = document.createElement("div");
    return e.classList.add("maplibregl-ctrl", "maplibregl-ctrl-group"), e.style.backgroundColor = "rgba(255, 255, 255, 0.9)", e.style.padding = "5px", e.style.borderRadius = "4px", e.style.display = "flex", e.style.flexDirection = "column", e.style.gap = "4px", this.options.buttons.forEach((t) => {
  ...
  updateLayout() {
    ...
    this.container.style.width = r ? "40px" : "auto", this.buttons.forEach((i) => {
      const s = i.querySelector("span");
      s && (s.style.display = r ? "none" : "inline");
    });
  }
  // Create a single button with icon and label
  createButton(e) {
    const t = document.createElement("button");
    t.style.display = "flex", t.style.alignItems = "center", t.style.gap = "6px", t.style.padding = "4px 8px", t.style.border = "none", t.style.backgroundColor = "transparent", t.style.cursor = "pointer", t.style.borderRadius = "4px";
    const r = _r(e.svg);
    t.appendChild(r);
    const i = document.createElement("span");
    return i.textContent = e.label, i.style.fontSize = "12px", t.appendChild(i), t.addEventListener("click", () => this.handleButtonClick(e)), t;
  }
  // Handle button click event
  handleButtonClick(e) {
    this.activeButtonId !== e.id && (this.buttons.forEach((t, r) => {
      t.style.backgroundColor = r === e.id ? Ur : "transparent";
    }), this.activeButtonId = e.id, this.map && this.options.onToggle && this.options.onToggle(this.map, e.id, e.layerIds));
  }
  // Add control to the map
  onAdd(e) {
    return this.map = e, this.options.buttons.length > 0 && !this.activeButtonId && this.handleButtonClick(this.options.buttons[0]), this.container;
  }
